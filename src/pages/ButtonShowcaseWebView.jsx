          ...
          <div className="flex-1 relative h-64 w-full md:h-auto">
            ...
            <div className="relative grid grid-cols-2 gap-4 p-4 h-full">
              <div className="bg-white border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-lg flex items-center justify-center -rotate-3 hover:rotate-0 transition-transform cursor-pointer group">
                <span className="material-symbols-outlined text-4xl group-hover:scale-125 transition-transform">touch_app</span>
              </div>
              <div className="bg-primary-fixed border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-lg flex items-center justify-center rotate-6 hover:rotate-0 transition-transform cursor-pointer group">
                <span className="material-symbols-outlined text-4xl group-hover:scale-125 transition-transform">mouse</span>
              </div>
              <div className="bg-on-surface text-white border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-lg flex items-center justify-center -rotate-6 hover:rotate-0 transition-transform cursor-pointer group">
                <span className="material-symbols-outlined text-4xl group-hover:scale-125 transition-transform">ads_click</span>
              </div>
              <div className="bg-surface-2 border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-lg flex items-center justify-center rotate-3 hover:rotate-0 transition-transform cursor-pointer group">
                <span className="material-symbols-outlined text-4xl group-hover:scale-125 transition-transform">gesture</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <section className="md:col-span-2 space-y-8">
            <div className="bg-surface border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8 rounded-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  <span className="font-label uppercase text-secondary">Disabled</span>
                  <Button variant="primary" disabled className="w-full">Disabled</Button>
                  <p className="text-caption text-secondary">Disabled state for unavailable actions.</p>
                </div>
                <div className="space-y-4">
                  <span className="font-label uppercase text-secondary">Loading</span>
                  <Button variant="primary" loading className="w-full">Loading</Button>
                  <p className="text-caption text-secondary">Loading state for asynchronous actions.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface-2 border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8 rounded-xl">
              ...
              <div className="flex flex-wrap items-end gap-12">
                <div className="flex flex-col items-center gap-4">
                  <Button variant="primary" style={{ padding: '1.5rem 3rem' }}>Large (64px)</Button>
                  <span className="text-caption font-label uppercase">Hero Actions</span>
                </div>
                <div className="flex flex-col items-center gap-4">
                  <Button variant="primary">Medium (48px)</Button>
                  <span className="text-caption font-label uppercase">Standard View</span>
                </div>
                <div className="flex flex-col items-center gap-4">
                  <Button variant="primary" style={{ padding: '0.5rem 1.5rem' }}>Small (32px)</Button>
            ...
            <div className="bg-surface border-2 border-on-surface shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-8 rounded-xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col items-center gap-2">
                  <Button variant="primary" className="w-16 h-16 rounded-full">
                    <span className="material-symbols-outlined">favorite</span>
                  </Button>
                  <span className="text-caption font-label uppercase">Icon Only</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-caption font-label uppercase">Icon Left</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <Button variant="primary" className="w-full">
                    Icon Right
                  ...
                  <span className="text-caption font-label uppercase">Icon Right</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <Button variant="primary" className="w-full">
                    <span className="material-symbols-outlined">favorite</span>
                  ...
                  <span className="text-caption font-label uppercase">Icon Both</span>
                </div>
              </div>
            </div>
          </aside>
